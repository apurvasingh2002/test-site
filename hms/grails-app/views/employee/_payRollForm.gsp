...
<div class="modal-dialog" style="width: 800px;">
    <div class="modal-content">
        ...
        <g:form id="gForm" url="[controller: 'employee', action:payRollInstance.id?'updatePayRoll':'savePayRoll',params:[id:payRollInstance.id] ]"  method="${payRollInstance.id?'POST':'PUT'}" >
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <td><label>Promotion Date:
                            <input  name="promotionDate" placeholder="Promotion Date" id="promotionDate" data-date-format="dd/mm/yyyy" data-provide="datepicker" value="${formatDate(format: 'dd/MM/yyyy', date: payRollInstance?.promotionDate)}" >
                        </label>
                        </td>
            ...
            <div class="modal-footer">
                <button type="button" class="save btn btn-primary" onclick="submitForm('Payroll')" >${payRollInstance.id?'Update':'Save'}</button>
