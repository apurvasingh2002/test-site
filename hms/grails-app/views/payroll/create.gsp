...
<html>
	...
	<body>
		%{--<a href="#create-payroll" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-payroll" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:payrollInstance, action:'save']" >
				<fieldset class="form">
